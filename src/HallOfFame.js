...
/**
 * Store the current player if his score is one of the highest
 * @param entry : the current player
 * @param onStored : callback with the HoF updated (=> display)
 **/
